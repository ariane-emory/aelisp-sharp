...
static partial class Ae
{
  ...
  //====================================================================================================================
  private record struct LispTokenizerState(
    int Line = 0, int Column = 0, LispTokenizerMode Mode = LispTokenizerMode.Normal, int ParenDepth = 0);

  //====================================================================================================================
  public record struct LispToken(LispTokenType Type, string? Text, int Line, int Column, int ParenDepth)
  {
    public override string ToString() =>
      (Text is null ? Type : $"{Type} [{Text.EscapeChars()}]") + $" @ {Line},{Column},{ParenDepth}";
  }
  ...
  private static readonly ImmutableArray<LispTokenType> CommentLispTokenTypes =
     [LispTokenType.Comment, LispTokenType.LineComment];
