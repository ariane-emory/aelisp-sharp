...
public static partial class Ae
{
  public enum TokenType
  {
    ...
    MultilineCommentEnd,
    MultilineCommentMatter,
    MultilineCommentWhites,
  ...
  public class Tokenizer : StringTokenizer<TokenType, PositionedToken<TokenType>, AeLispTokenizerState>
  {
    ...
    private static readonly List<(TokenType Type,
                ...
                string Pattern)>
      {
        ...
        (Type: TokenType.MultilineCommentNewline, Discrete: false, Process: CountLine,         IsActive: InMultilineComment, Pattern: @"\r?\n"),
        ...
        (Type: TokenType.MultilineCommentWhites,  Discrete: false, Process: CountColumns,      IsActive: InMultilineComment, Pattern: @"[ \t\f\v]+"),
    ...
    private static (AeLispTokenizerState, PositionedToken<TokenType>) ProcBeginMLC((AeLispTokenizerState State, PositionedToken<TokenType> Token) tup)
    {
      tup = CountColumns(tup);
    ...
    private static (AeLispTokenizerState, PositionedToken<TokenType>) ProcEndMLC((AeLispTokenizerState State, PositionedToken<TokenType> Token) tup)
    {
      tup = CountColumns(tup);
